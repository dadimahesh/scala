...
from ._exceptions import APIStatusError, McpprojectError
...
class Mcpproject(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Mcpproject client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("MCPPROJECT_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> McpprojectWithRawResponse:
        return McpprojectWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> McpprojectWithStreamedResponse:
        return McpprojectWithStreamedResponse(self)
...
class AsyncMcpproject(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncMcpproject client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncMcpprojectWithRawResponse:
        return AsyncMcpprojectWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncMcpprojectWithStreamedResponse:
        return AsyncMcpprojectWithStreamedResponse(self)
...
class McpprojectWithRawResponse:
    _client: Mcpproject

    def __init__(self, client: Mcpproject) -> None:
        self._client = client
...
class AsyncMcpprojectWithRawResponse:
    _client: AsyncMcpproject

    def __init__(self, client: AsyncMcpproject) -> None:
        self._client = client
...
class McpprojectWithStreamedResponse:
    _client: Mcpproject
...
class AsyncMcpprojectWithStreamedResponse:
    _client: AsyncMcpproject
