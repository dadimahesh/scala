...
class StoreResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> StoreResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/mcpproject-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> StoreResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/mcpproject-python#with_streaming_response
        """
