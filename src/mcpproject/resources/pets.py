...
class PetsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> PetsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/dadimahesh/scala#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> PetsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/dadimahesh/scala#with_streaming_response
        """
